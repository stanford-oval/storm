  ...
  const faqs = [
    {
      ...
      answer: "STORM (Synthesis of Topic Outline through Retrieval and Multi-perspective question asking) is an AI-powered system that generates comprehensive Wikipedia-like articles through automated research and writing."
    },
    {
      question: "How do I get started?",
      answer: "1. Set up your API keys in Settings\n2. Create a new project\n3. Configure your pipeline settings\n4. Run the pipeline to generate your article"
    },
    {
      question: "What API keys do I need?",
      answer: "You need at least one LLM provider key (OpenAI or Anthropic) and one search provider key (Google, Tavily, Serper, etc.). Configure these in the Settings page."
    },
    {
      question: "How long does article generation take?",
      answer: "Typically 5-15 minutes depending on the topic complexity, chosen model, and pipeline configuration. Research phase usually takes the longest."
    },
    {
      question: "Can I edit the generated articles?",
      answer: "Yes! Articles can be edited after generation. You can also modify the outline before article generation to influence the final output."
    },
    {
      question: "What's the difference between models?",
      answer: "GPT-4 provides the highest quality but is slower and more expensive. GPT-3.5 is faster and cheaper but may produce less nuanced content. Claude models offer a good balance."
    },
    {
      question: "How much does it cost?",
      answer: "Costs depend on your chosen models and article length. Typically $0.20-$1.00 per article with GPT-3.5, or $1-5 with GPT-4."
    },
    {
      question: "Can I use my own documents?",
      answer: "Yes! You can configure a vector database (Qdrant) to use your own document corpus for research instead of web search."
    }
  ];
  ...
  return (
    <div className="container mx-auto py-6 space-y-6 max-w-6xl">
      <div>
        ...
        <p className="text-muted-foreground">Everything you need to know about using STORM UI</p>
      </div>
                  ...
                  <ol className="space-y-2">
                    {guide.steps.map((step, stepIndex) => (
                      <li key={stepIndex} className="flex items-start">
                        <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs flex items-center justify-center mr-2">
                          {stepIndex + 1}
                        </span>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  The research stage simulates conversations between AI agents with different perspectives to gather comprehensive information about your topic.
                </p>
                <ul className="list-disc list-inside text-sm space-y-1">
                  <li><strong>Max Conversation Turns:</strong> More turns = more thorough research (5-10 recommended)</li>
                  <li><strong>Max Perspectives:</strong> Number of different viewpoints to explore (3-5 recommended)</li>
                  <li><strong>Search Results:</strong> More results provide better coverage but take longer</li>
                </ul>
              </div>
              ...
              <div>
                <h3 className="font-semibold mb-2">Outline Generation</h3>
                <p className="text-sm text-muted-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">Article Writing</h3>
                <p className="text-sm text-muted-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">Polish Stage</h3>
                <p className="text-sm text-muted-foreground mb-2">
